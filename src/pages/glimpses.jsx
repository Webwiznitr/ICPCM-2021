...
<NameGlimpseSection style={{color:Colors.primary}}> Glimpse of our conference </NameGlimpseSection>
        ...
        <Slider autoplaySpeed = { 1500 }  autoplay = {true}  adaptiveHeight = {true} slidesToShow = {3}  arrows = { false}>
            ...
            <img src = "https://res.cloudinary.com/manjeetdhayal/image/upload/v1629134957/redsea/gly_im5_jnnmpx.jpg" alt="img not found" />
        </Slider>
